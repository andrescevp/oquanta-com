...
import { WebSite as WebSiteSchema, WebPage as WebPageSchema, Service as ServiceSchema } from 'schema-dts'
...
function Index () {
  ...
  updateHead({
    ...
    description: t('Plataforma de encuestas de oQuanta que te ayuda a recopilar feedback real de tus clientes y mejorar tus servicios.'),
    ...
    <>
      <JsonLd<WebPageSchema>
        item={{
          ...
          description: 'Plataforma de encuestas que te ayuda a recopilar feedback real de tus clientes y mejorar tus servicios.',
            ...
            <div className='relative'>
              <div className='aspect-[4/3] bg-black-30 rounded-lg'>
                <LazyLoad height='450px'>
                  <img
                      src={secondImage} alt={t('Imagen de una encuesta de un bar en un dispositivo movil')}
          ...
          <div className='grid md:grid-cols-2 gap-12'>
            ...
            <div className='relative'>
              <div className='aspect-[4/3] bg-black-30 rounded-lg'>
                <LazyLoad height='450px'>
                  <img
                      src={firstImage} alt={t('Imagen de un reporte estadístico en un dispositivo movil')}
                      className='w-full h-full object-cover rounded-lg'
                    />
                </LazyLoad>
              </div>
            ...
            <div>
              <div className='text-center mb-6'>
                <div className='inline-flex flex-col items-center'>
                  ...
                  <span
                      className='inline-block w-8 h-8 rounded-full bg-[#6B46FF] text-white font-bold flex items-center justify-center'
                    >1
                    </span>
                </div>
              </div>
          ...
          <div className='grid md:grid-cols-2 gap-12'>
            ...
            <div className='relative'>
              <div className='aspect-[4/3] bg-black-30 rounded-lg'>
                <LazyLoad height='450px'>
                  <img
                      src={secondImage} alt={t('heroImageAlt')}
                      className='w-full h-full object-cover rounded-lg'
                    />
                </LazyLoad>
              </div>
